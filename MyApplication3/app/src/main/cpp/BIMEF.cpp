...
void  BIMEF(const cv::Mat& input, cv::Mat& output, float mu = 0.5f, float a = -0.3293f, float b = 1.1258f)//;BIMEF(InputArray input, OutputArray output, float mu, float a, float b)
{
